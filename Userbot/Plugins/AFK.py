...
async def on_afk(event):
    ...
    if USER_AFK and not (await event.get_sender()).bot:  # pylint:disable=E0602
        ...
        message_to_reply = (
            ...
            f"__My Master/Mistress Has Been In afk since__ `{total_afk_time}`\nWhere He/She Is: WHO ARE YOU TO KNOW WHERE MY DEPLOYER IS..\n IF IT'S URGENT TO TALK WITH HIM/HER ..LEAVE 987654321$ THEN\n MY BOSS MAY ANSWER YOU WITHIN 99999999999999999999 LIGHT YEARS.. "

            + f"\n\n__I can't guarantee you that when he will come..__\n**REASON**: {reason}"

            if reason

            else f"**BTW My boss left a message for you!**\n__I am currently unavailable. Since when, you ask? For {total_afk_time} I guess.__\n\nWhen will I be back? Soon __Whenever I feel like coming back__**((✷‿✷))**  "
