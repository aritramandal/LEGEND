...
if Var.TG_BOT_USER_NAME_BF_HER is not None and tgbot is not None:
    ...
    async def on_plug_in_callback_query_handler(event):
        ...
        if event.query.user_id == bot.uid:  # pylint:disable=E0602
            ...
            reply_pop_up_alert = "Deploy your own userbot stupod.., don't use Mine\n check @LEGEND_USERBOT_SUPPORT For support.. !"
    ...
    async def on_plug_in_callback_query_handler(event):
        ...
        if event.query.user_id == bot.uid:  # pylint:disable=E0602
            ...
            reply_pop_up_alert = "Deploy your own userbot stupid, don't use Mine\n  For The Support!"
    ...
    async def on_plug_in_callback_query_handler(event):
        ...
        reply_pop_up_alert += "\n Use .unload {} to remove this plugin it may not work sorry for that\n\

            ®LEGEND™".format(plugin_name)
        ...
        try:
            ...
            with io.BytesIO(str.encode(reply_pop_up_alert)) as out_file:
                ...
                await event.client.send_file(
                    ...
                    caption="Uploaded By @LEGEND_USERBOT_SUPPORT"
