#"""Update UserBot Code (FOR LEGEND USERBOT)
#Syntax: .update
...
UPSTREAM_REPO_URL = "http://github.com/aritramandal/LEGEND"
...
async def upstream(ups):
    ...
    await ups.edit("wait pro... checking for new updates.. ")
    ...
    try:
        ...
        if conf != "now":
            await ups.edit(f"** To proceed updating please type =>**`.update now`")
            return
        repo = Repo.init()
    ...
    if conf != "now" and not force_update:
        ...
        return
    if force_update:
        await ups.edit('Force-Syncing to latest stable userbot code, Please wait a while... Till i update me for you🥰..')
    else:
        await ups.edit('Updating your PA the Legend userbot, please wait....\nDo `.update now` if u[date doesnt took place...')
